...
<section style="padding: 100px 0; background-color: #ffffff;">
    <div class="container flex-col-1024" style="display: flex; align-items: center; gap: 80px;">
        ...
        <div style="flex: none; width: 100%; max-width: 545px; height: auto; border-radius: 30px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
            <img src="/public/assets/images/properties/uk-houses/uk-2.jpg" alt="Your Tenancy at Ark Housing" style="width: 100%; height: 100%; object-fit: cover;">
        </div>

        <!-- Right: Content -->
        <div style="flex: 1; width: 100%;">
            <h2 style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 39.8px; line-height: 1.2; color: #1a1a2e; margin-bottom: 24px;">Your Tenancy</h2>
...
<section style="padding: 100px 0; background-color: #ffffff;">
    <div class="container" style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;">
        ...
        <!-- Box 1: Pay Rent -->
        <div class="pop-card" style="width: 100%; max-width: 300px; height: auto; min-height: 205px; background: #ffffff; border-radius: 30px; padding: 32px; display: flex; flex-direction: column; justify-content: flex-start; box-shadow: 0 10px 30px rgba(0,0,0,0.08), 0 4px 6px rgba(0,0,0,0.02); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer;" onmouseenter="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 20px 40px rgba(0,0,0,0.12)';" onmouseleave="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.08)';">
            <div>
...
<section style="padding: 0 0 100px 0; background-color: #ffffff;">
    <div class="container" style="display: flex; justify-content: center;">
        <div class="flex-col-1024" style="width: 100%; max-width: 1120px; height: auto; min-height: 260px; background-color: #1FAF38; border-radius: 40px; padding: 40px 80px; display: flex; align-items: center; justify-content: space-between; gap: 40px; box-shadow: 0 20px 40px rgba(31, 175, 56, 0.15);">
            <div>
